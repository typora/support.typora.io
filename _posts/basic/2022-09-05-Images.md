...
If you use this menu item frequently, we suggest you re-assign the shortcut key for this "insert image" command following [Custom Key Binding](/Shortcut-Keys/#change-shortcut-keys).
