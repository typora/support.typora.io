...
9. Fuzzy search in Quick Open will now also match folder path.
...
- Support mermaid config (<https://mermaid-js.github.io/mermaid/#/./directives>)
...
- Add options to enable `./` prefix of the relative path when drop or insert images. This will improve compatibility with some 3rd markdown engines, like `VuePress`.
