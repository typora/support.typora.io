...
You could also [contact us](mailto:store@typora.io) for free license if you have contributed in Typora, including accepted [translations](https://github.com/typora/Typora-i18n) and [themes](https://github.com/typora/typora-theme-gallery). We have actually send coupon codes to contributors if we can find their mail address on their Github profile page, so you can check your spam before contacting us.
