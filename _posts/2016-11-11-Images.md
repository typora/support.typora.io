...
### Copying image files to target folder when inserting local images

> To use this feature, you need to enable the option `Allow copy images to given folder` in the preferences menu.
